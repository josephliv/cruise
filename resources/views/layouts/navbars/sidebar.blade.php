<div id="mySidenav" class="sidenav">
  ...
  <div class="side-bar-links">
    <ul class="nav">
      ...
      <li class="nav-item"> <a href="{{route('user.index')}}" title="View or edit your agents"><i class="nc-icon nc-circle-09"></i>&nbsp;{{ __("Manage Agents") }}</a></li>
      <li class="nav-item"><a href="{{route('emails.manage')}}" title="View or edit the leads"><i class="nc-icon nc-email-85"></i>&nbsp;{{ __("Manage Leads") }}</a></li>
      <li class="nav-item"><a href="{{route('priorities.index')}}" title="View or edit the priorities"><i class="nc-icon nc-preferences-circle-rotate"></i>&nbsp;{{ __("Rules & Priorities") }}</a></li>
