...
<div class="tab-content">
                                    ...
                                    @foreach ($leadMails as $leadMail)
                                        ...
                                        <tr>
                                            ...
                                            @elseif (optional($leadMail)->rejected > 0) 
                                                ...
                                                <a data-toggle="modal" data-id="{{optional($leadMail)->id}}" data-type="rejected" data-target="#leadsModal" class="getbody d-inline-block"style="cursor: pointer" title="Rejected message"> &#128393;</a>
  ...
  <div class="tab-pane  active" id="unassigned" role="tabpanel" aria-labelledby="home-tab">
    <div id="unassigned">
                            <table class="table table-bordered table-striped  table-responsive" id="lead-table1">
                                <thead style="text-align: center; position: sticky; top: 0; z-index: 99; background-color:aqua; font-weight: bold;">
                                    ...
                                    <th class="col-5">Subject Line </th>
  ...
  <div class="tab-pane" id="assigned" role="tabpanel" aria-labelledby="profile-tab">
        <div id="assigned">
                                <table class="table table-bordered table-striped  table-responsive" id="lead-table2">
                                    <thead style="position: sticky; top: 0; z-index: 99; background-color:aqua; font-weight: bold;">
                                        <th>#</th>
                                        <th class="col-3">Sender </th>
                                        <th class="col-4">Subject Line </th>
  ...
  <div class="tab-pane" id="rejected" role="tabpanel" aria-labelledby="messages-tab">
        <div id="rejected" >
                                <table class="table table-bordered table-striped  table-responsive" id="lead-table3">
  ...
  <div class="tab-pane" id="reassigned" role="tabpanel" aria-labelledby="settings-tab">
        <div id="reassigned" >
                                <table class="table table-bordered table-striped  table-responsive" id="lead-table4">
                                    <thead style="text-align: center; padding: 5px 10px; position: sticky; top: 0; z-index: 99; background-color:aqua; font-weight: bold;">
                                        <th>#</th>
                                        <th class="col-3">Sender </th>
                                        <th class="col-4">Subject Line </th>
                                        <th class="col-2">Orig. Agent </th>
                                        <th class="col-2" >Curr. Agent </th>
                                        <th class="col-1">Time/date</th>
                                        <th>Options</th>
                                    </thead>
                                    <tbody>
