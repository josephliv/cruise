 ...
 */
?>
@extends('layouts.app', ['activePage' => 'leads-management', 'title' => 'Cruiser Travels Leadbox Management System',
'navName' => 'Leads Management', 'activeButton' => 'laravel'])
...
@section('content')
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card striped-tabled-with-hover">
                        ...
                        <div class="card-body">
                            <?php
                            // Naughty coding? Should be using the DB Functions
                            // A Rejected Email must have am agent_id > 0 else it wont be counted as rejected
                            ...
                            <div class="p-4 text-center">
                                ...
                                <form method='POST'>
                                    ...
                                    <input type="date" id="from-date" name="from-date"
                                           value="{{ explode(' ', $dateFrom)[0] }}"> to <input type="date" id="to-date"
                                                                                               name="to-date" value="{{ explode(' ', $dateTo)[0] }}">
                            ...
                            <ul class="nav nav-pills nav-justified mb-4" id="myTab" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link active" id="total-tab" data-toggle="tab" href="#totalLeads"
                                       role="tab" aria-controls="home" aria-selected="true">Total Leads
                                        ({{ $leadMails->count() }})</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="home-tab" data-toggle="tab" href="#unassigned" role="tab"
                                       aria-controls="home" aria-selected="true">Unassigned ({{ $unassignedTotal }})</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="profile-tab" data-toggle="tab" href="#assigned" role="tab"
                                       aria-controls="profile" aria-selected="false">Assigned ({{ $assignedTotal }})</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="messages-tab" data-toggle="tab" href="#rejected"
                                       role="tab" aria-controls="messages" aria-selected="false">Rejected
                                        ({{ $rejectedTotal }})</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="settings-tab" data-toggle="tab" href="#reassigned"
                                       role="tab" aria-controls="settings" aria-selected="false">Reassigned
                                        ({{ $reassignedTotal }})</a>
                                </li>
                            </ul>
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="totalLeads" role="tabpanel" aria-labelledby="home-tab">
                                    <div id="totalLeads">
                                        <table class="table table-striped  table-responsive" id="lead-table0">
                                            <thead>
                                            <th>#</th>
                                            <th>Sender</th>
                                            <th>Status</th>
                                        ...
                                        @endif --}}
                                                    ...
                                                    <td class="col-md-5"><span id="mail-subject">{{ optional($leadMail)->subject }}</span></td>
                                                    <td>{{$leadMail->group_name}}</td>
                                                    <td>{{optional($leadMail)->priority}}</td>
                                                    <td class="col-md-2"><span
                                                                id="mail-date">{{ \Carbon\Carbon::parse(optional($leadMail)->received_date)->format('m/d/Y g:i A') }}</span>
                                                    </td>
                                                    <td class="d-flex justify-content-end">
                                                        @if (optional($leadMail)->attachment)
                                                            <a href="{{ route('leads.download', optional($leadMail)->id) }}"
                                                               target="_blank"
                                                               class="btn btn-link btn-warning edit d-inline-block"
                                                               title="Attachment available."><i
                                                                        class="fa fa-paperclip text-primary font-weight-bold"></i></a>
                                                        @else
                                                            <a href="#" target="_blank"
                                                               class="btn disabled btn-link btn-warning edit d-inline-block"><i
                                                                        class="fa fa-paperclip"></i></a>
                                                        @endif
                                                        <a data-toggle="modal" data-id="{{ optional($leadMail)->id }}"
                                                           data-type="body" data-target="#leadsModal"
                                                           class="btn btn-link btn-warning getbody d-inline-block"><i
                                                                    class="fa fa-file" title="Read full email."></i></a>
                                                        @if ($leadMail->rejected)
                                                            <a data-toggle="modal"
                                                               data-id="{{ optional($leadMail)->id }}"
                                                               data-type="rejected" data-target="#leadsModal"
                                                               class="btn btn-link btn-warning getbody d-inline-block"><i
                                                    ...
                                                    <!-- this is suppose to display the reassigned message but it isn't showing the icon -->
                                                        @if (optional($leadMail)->old_agent_id > 0)
                                                            <a data-toggle="modal" data-id="{{ $leadMail->id }}"
                                                               data-type="reassigned" data-target="#leadsModal"
                                                               class="btn btn-link btn-warning getbody d-inline-block"><i
                                                                        class="fa fa-paper-plane"
                                                                        title="Reassigned message"></i></a>
                                                        @endif
                                                        <a data-toggle="modal" data-id="{{ optional($leadMail)->id }}"
                                                           data-original-user="{{ optional(optional($leadMail)->agent)->id }}"
                                                           data-type="body" data-target="#sendLeadModal"
                                                           class="btn btn-link btn-warning direct-send-lead d-inline-block"><i
                                                                    class="fa fa-envelope"
                                                                    title="Manually Send Lead"></i>
                                                        </a>

                                                        <a class="btn btn-link btn-danger"
                                                           onclick="confirm('{{ __('Are you sure you want to delete this Lead?') }}') ? window.location.href='{{ route('leads.destroy', optional($leadMail)->id) }}' : ''"
                                    ...
                                    <div id="unassigned">
                                        <table class="table-striped table-responsive" id="lead-table1">
                                            ...
                                            @foreach ($leadMails as $leadMail)
                                                @if (optional($leadMail)->agent_id == 0)
                                                    <tr>
                                                        <td><span id="mail-from">{{ optional($leadMail)->id }}</span>
                                                        </td>
                                                        <td><span
                                                                    id="mail-from">{{ optional($leadMail)->email_from }}</span>
                                                        </td>
                                                        <td class="col-12 col-md-6"><span
                                                                    id="mail-subject">{{ optional($leadMail)->subject }}</span>
                                                        </td>
                                            ...
                                            @foreach ($leadMails as $leadMail)
                                                @if ($leadMail->agent_id > 0)
                                                    <tr>
                                                        ...
                                                        <td>{{ optional(optional($leadMail->agent())->first())->name }}
                                                        </td>

                                                        <td><span
                                                                    id="mail-date">{{ \Carbon\Carbon::parse($leadMail->received_date)->format('m/d/Y g:i A') }}</span>
                                                        </td>
                                                        <td class="d-flex justify-content-end">
                                                            @if ($leadMail->attachment)
                                                                <a href="{{ route('leads.download', $leadMail->id) }}"
                                                                   target="_blank"
                                                                   class="btn btn-link btn-warning edit d-inline-block"
                                                                   title="Attachment available."><i
                                                                            class="fa fa-paperclip"></i></a>
                                            ...
                                            @foreach ($leadMails as $leadMail)
                                                @if (optional($leadMail)->rejected != 0)
                                                    <tr>
                                                        ...
                                                        <td class="col-12 col-md-6">{{ optional($leadMail)->subject }}
                                                        </td>
                                                        <td>{{ optional(optional(optional($leadMail)->agent())->first())->name }}
                                                        </td>
                                                ...
                                                @if (optional($leadMail)->old_agent_id != 0 && !$leadMail->rejected)
                                                    <tr>
                                                        ...
                                                        <td class="d-flex justify-content-center">
                                                            @if (optional($leadMail)->attachment)
                                                                <a href="{{ route('leads.download', $leadMail->id) }}"
                                                                   ...
                                                                   title="Attachment available."><i
                                                                            class="fa fa-paperclip"></i></a>
                                                            @else
                                                                <a href="#" target="_blank" class="btn disabled btn-link btn-warning edit d-inline-block">
                                                            ...
                                                            <a class="btn btn-link btn-danger "
                                                               onclick="confirm('{{ __('Are you sure you want to delete this Lead?') }}') ? window.location.href='{{ route('leads.destroy', $leadMail->id) }}' : ''"
                                                               s><i class="fa fa-times" title="Delete."></i></a>
                                                        </td>
                                                    </tr>
                                                @endif
    ...
    <div class="modal fade" id="leadsModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
    ...
    <div class="modal fade" id="sendLeadModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
         aria-hidden="true" style="display: none;">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header" style="background: #ccc;">
