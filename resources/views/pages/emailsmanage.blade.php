                                        ...
                                        @if($leadMail->agent_id == 0)
                                            <tr>
                                                ...
                                                <td class="d-flex justify-content-end">
                                                    ...
                                                    <a data-toggle="modal" data-id="{{$leadMail->id}}" data-original-user="" data-type="body" data-target="#sendLeadModal" class="btn btn-link btn-warning direct-send-lead d-inline-block"><i
                                                                class="fa fa-envelope" title="Manually Send Lead"></i></a>
                                                    ...
                                                    <a class="btn btn-link btn-danger " onclick="confirm('{{ __('Are you sure you want to delete this Lead?') }}') ? window.location.href='{{ route('leads.destroy', $leadMail->id) }}' : ''"><i
                                            ...
                                            <tr>
                                                ...
                                                <td class="d-flex justify-content-end">
                                                    ...
                                                    @else
                                                        <a href="#" target="_blank" class="btn disabled btn-link btn-warning edit d-inline-block"><i class="fa fa-paperclip"></i></a>
                                                    @endif
                                                    <a data-toggle="modal" data-id="{{$leadMail->id}}" data-type="rejected" data-target="#leadsModal" class="btn btn-link btn-warning getbody d-inline-block"><i class="fa fa-paper-plane"
